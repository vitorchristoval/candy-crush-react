...
import greeCandy from './images/green-candy.png';
...
const App = () => {
  ...
  const checkForColumnOfFour = () => {
    for (let i = 0; i <= 39; i++) {
      const columOfFour = [i, i + width, i + width * 2, i + width * 3] //calculo veriticalmente os itens de array em 4, 0,8,16 (por exemplo os 4 primeiros itens da primeira coluna)
  ...
  const checkForColumnOfThree = () => {
    for (let i = 0; i <= 47; i++) {
      const columOfThree = [i, i + width, i + width * 2] //calculo veriticalmente os itens de array em 3, 0,8,16 (por exemplo os 3 primeiros itens da primeira coluna)
      const decidedColor = currentColorArrangement[i]
      const isBlank = currentColorArrangement[i] == blank
